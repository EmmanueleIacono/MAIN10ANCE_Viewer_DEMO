...
<div>
  <div class="scheda-anagrafica">
    ...
    <textarea v-model="state.descrizione_sistema" :disabled="schedaRegistrata" style="height: 20px;"></textarea>
    <br />
    <label><b>DESCRIZIONE SUBSISTEMA</b></label>
    <textarea v-model="state.descrizione_subsistema" :disabled="schedaRegistrata" style="height: 20px;"></textarea>
    <br />
    <label><b>TECNICA COSTRUTTIVA</b></label>
    <input v-model="state.tecnica_costruttiva" :disabled="schedaRegistrata">
    <br />
    <label><b>DIMENSIONI</b></label>
    <input v-model="state.dimensioni" :disabled="schedaRegistrata">
    <br />
    <label><b>MATERIALE/I</b></label>
    <input v-model="state.materiale" :disabled="schedaRegistrata">
    <br />
    <label><b>EPOCA</b></label>
    <input v-model="state.epoca" :disabled="schedaRegistrata">
    <br />
    <label><b>ISPEZIONABILITÀ</b></label>
    <input v-model="state.ispezionabilità" :disabled="schedaRegistrata">
    <br />
    <label><b>FONTI</b></label>
    <input v-model="state.fonti" :disabled="schedaRegistrata">
    <br />
  </div>
</div>
</template>
