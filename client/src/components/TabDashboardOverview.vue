...
<div class="row loading-wrapper" id="Overview">
  ...
  <OverviewItem :data="state.utentiData" :labels="state.utentiLabels" :infoContenuto="'utenti'" :icona="'zmdi-account-o'" :gradiente="'overview-item--c1'" />
  <OverviewItem :data="state.modelliData" :labels="state.modelliLabels" :infoContenuto="'modelli'" :icona="'zmdi-home'" :gradiente="'overview-item--c2'" />
  <OverviewItem :data="state.oggettiData" :labels="state.oggettiLabels" :infoContenuto="'oggetti'" :icona="'zmdi-info'" :gradiente="'overview-item--c3'" />
